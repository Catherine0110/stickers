(() => {
  ...
  function initSwiper(slider2) {
    const sliderParams = JSON.parse(slider2.getAttribute("data-slider"));
    const sliderPagination = slider2.querySelector(".swiper-pagination");
    const sliderBtnNext = slider2.querySelector(".swiper-button-next");
    const sliderBtnPrev = slider2.querySelector(".swiper-button-prev");
    const swiper = new core_default(slider2, {
      pagination: {
        el: sliderPagination
      },
      navigation: {
  ...
  var btnHide = document.querySelector(".js-hide-cards");
  var btnHideText = document.querySelector(".js-hide-cards-text");
  var btnHideTextContent = btnHideText && btnHideText.textContent;
  var cardsWrap = document.querySelector(".js-cards-wrap");
  var cardsWrapHeight = cardsWrap && cardsWrap.offsetHeight;
